...
const Testimonials = () => {
    ...
    return (
        <div className="h-fit flex items-center justify-center flex-col gap-15">
            ...
            <motion.div initial={{opacity: 0, translateX: "-20px"}} whileInView={{opacity: 1, translateX: "0"}} viewport={{once: true}}  transition={{duration: 1}} className="grid grid-cols-3 gap-3 w-[80%] mx-auto grid-flow-dense">
                {
