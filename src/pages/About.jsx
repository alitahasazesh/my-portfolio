...
const About = () => {
    return (
        <div className="h-[100vh] relative pt-10 flex items-center justify-center">
            <motion.p initial={{opacity: 0, translateY: "20px"}} whileInView={{opacity: 1, translateY: 0}} transition={{duration: 2}} className="text-[#c2c2c2] text-2xl max-md:text-xl max-sm:text-md  leading-10 max-w-[600px] mx-auto font-inter relative text-justify">
